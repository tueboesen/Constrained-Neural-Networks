...
output_dir_eq = '/home/tue/remote_desktop/eq999_1000train/'
output_dir_mim = '/home/tue/remote_desktop/mim999_1000train/'
...
legends = ['No constraints','Triangle','Triangle end']
...
#
# legends = ['No constraints', 'Chain', 'Triangle', 'Chaintriangle', 'End chain', 'End triangle', 'End chaintriangle', 'Reg chain', 'Reg triangle', 'Reg chaintriangle']
plot_training_and_validation_accumulated_custom(result_eq,legends,output_dir_eq,colors,semilogy=True,fill_between=True,train_limits=False)
