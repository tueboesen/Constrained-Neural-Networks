...
folders = ['/home/tue/remote_desktop/2022-04-05_10_39_30/']
...
output_dir = '/home/tue/remote_desktop/inherent1000/'
os.makedirs(output_dir,exist_ok=True)
...
#
# legends = ['No constraints', 'Chain', 'Triangle', 'Chaintriangle', 'End chain', 'End triangle', 'End chaintriangle', 'Reg chain', 'Reg triangle', 'Reg chaintriangle']
plot_training_and_validation_accumulated_custom(results_selected,legends,output_dir,colors,semilogy=True,fill_between=True,train_limits=True)
