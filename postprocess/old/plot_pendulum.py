...
folders = ['/home/tue/PycharmProjects/results/test_pendulum/2022-05-25_23_51_27/']
...
output_dir = '/home/tue/remote_desktop/pendulum/'
os.makedirs(output_dir,exist_ok=True)
...
#
# legends = ['No constraints', 'Chain', 'Triangle', 'Chaintriangle', 'End chain', 'End triangle', 'End chaintriangle', 'Reg chain', 'Reg triangle', 'Reg chaintriangle']
plot_training_and_validation_accumulated_custom(result,legends,output_dir,colors,semilogy=True,fill_between=True,train_limits=False)
