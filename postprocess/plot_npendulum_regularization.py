...
folders = ['/home/tue/remote_desktop/test_pendulum_regularization/2022-08-23_13_07_34/']  # train 100, skip 20


output = 'regularization_sweep'
...
legends = [r'$\eta=0$', r'$\eta=1$', r'$\eta=10$', r'$\eta=100$', r'$\eta=1000$']
